...
const faqs = [
  { q: "الكتب ورقية ولا رقمية؟", a: "الاتنين! الكتب الـ 3 مطبوعة بتوصلك في بوكس واحد + نسخ رقمية بتوصلك فوراً. الأدوات الـ 9 كمان مطبوعة في البوكس. البونصات كلها رقمية بتتفعّل فوراً." },
