  ...
  return (
    <section ref={ref} className={`py-20 md:py-28 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
      <div className="container max-w-5xl mx-auto px-4 space-y-12">
        ...
        {/* Book 1 - BGM */}
        <div className="bg-[#141414] border border-white/5 border-r-4 border-r-blue-500 rounded-2xl p-8 md:p-10 space-y-6">
        ...
        {/* Book 2 - GrowthDNA */}
        <div className="bg-[#141414] border border-white/5 border-r-4 border-r-emerald-500 rounded-2xl p-8 md:p-10 space-y-6">
          <div className="flex flex-wrap items-center gap-4">
            <span className="text-3xl">📗</span>
            <div>
        ...
        <div className="bg-[#141414] border border-white/5 border-r-4 border-r-amber-500 rounded-2xl p-8 md:p-10 space-y-6">
          <div className="flex flex-wrap items-center gap-4">
            <span className="text-3xl">📙</span>
            <div>
