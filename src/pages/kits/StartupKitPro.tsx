        ...
        <div className="container mx-auto px-4 max-w-5xl space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              { q: "لديّ أسئلة إضافية؟", a: "نحن متاحون دائماً. تواصل معنا عبر البريد الإلكتروني أو واتساب وسنردّ عليك فوراً: hi@readtolead.store" },
              { q: "كيف أُفعّل المنصة الرقمية؟", a: "داخل الكتاب ستجد كود تفعيل خاص. ادخل إلى startupkitpro.lovable.app، سجّل حساباً جديداً، وأدخل الكود — ستحصل على 6 أشهر وصول كامل فوراً." },
              { q: "ماذا يحدث بعد انتهاء الأشهر الستة؟", a: "يمكنك تجديد الاشتراك بسعر مخفّض حصري لأصحاب المجموعات ($49/سنة)، أو تبقى بياناتك محفوظة ويمكنك تصديرها في أي وقت." },
